...
# echo "Building for iOS simulator - disabled GPU"
...
if [ ! -d ../../ios/lib/x86_64 ]; then
  mkdir -p ../../ios/lib/x86_64
fi

mv ../../tmp/skia/iOS_x64/libskia.a ../../ios/lib/x86_64
mv ../../tmp/skia/iOS_x64/libskottie.a ../../ios/lib/x86_64
mv ../../tmp/skia/iOS_x64/libskshaper.a ../../ios/lib/x86_64
mv ../../tmp/skia/iOS_x64/libsksg.a ../../ios/lib/x86_64
mv ../../tmp/skia/iOS_x64/libskparagraph.a ../../ios/lib/x86_64
