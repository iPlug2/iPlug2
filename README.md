...
**NOTE:** We don't yet consider iPlug2 to be "production ready" since the we (the main devs) didn't ship our products with it yet, bit it's nearly ready! Read more [here](https://github.com/iPlug2/iPlug2/wiki/04_FAQ)
