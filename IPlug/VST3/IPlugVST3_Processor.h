 ...
 *   @ingroup APIClasses */
class IPlugVST3Processor : public Steinberg::Vst::AudioEffect, public IPlugAPIBase, public IPlugVST3ProcessorBase
{
public:
  struct InstanceInfo
  {
  ...
  } // NOOP in VST3 processor -> param change gets there via IPlugVST3Controller::setParamNormalized
