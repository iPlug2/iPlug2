...
public:
  ...
  : Steinberg::Vst::Parameter(
    STR16("Preset"), kPresetParam, STR16(""), 0, nPresets - 1, Steinberg::Vst::ParameterInfo::kIsProgramChange)
  {
  }
...
public:
  ...
  : Steinberg::Vst::StringListParameter(STR16("Bypass"), kBypassParam, 0,
