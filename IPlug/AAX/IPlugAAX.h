...
public:
  ...
  AAX_Result SetControlHighlightInfo(AAX_CParamID iParameterID, AAX_CBoolean iIsHighlighted,
 ...
 *   @ingroup APIClasses */
class IPlugAAX : public IPlugAPIBase, public IPlugProcessor, public AAX_CIPlugParameters
{
public:
  ...
  void RenderAudio(AAX_SIPlugRenderInfo* ioRenderInfo, const TParamValPair* inSynchronizedParamValues[],
  ...
  // IPlugAAX
  /** This is needed in chunks based plug-ins to tell PT a non-indexed param changed and to turn on the compare light.
   * You can call this method from your plug-in implementation by doing a dynamic_cast in order to convert an "IPlug"
   * into a "IPlugAAX"
   */
