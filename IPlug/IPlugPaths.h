...
extern EResourceLocation FindResource(const char* fileNameOrResID, const char* type, WDL_String& result, const char* bundleID = nullptr, void* pHInstance = nullptr);
