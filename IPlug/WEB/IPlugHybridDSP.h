 ...
 *
 * @ingroup APIClasses */
class IPlugHybridDSP : public IPlugAPIBase
                      , public IPlugProcessor
{
public:
  IPlugHybridDSP(const InstanceInfo& info, const Config& config);
  virtual ~IPlugHybridDSP() = default;
...
IPlugHybridDSP* MakePlug(const InstanceInfo& info);
