...
/** This is used for the UI "editor" - controller side of a WAM or remote editors that communicate with desktop iPlug
 * plug-ins via web sockets
 * @ingroup APIClasses */
...
public:
  ...
  //  void BeginInformHostOfParamChangeFromUI(int paramIdx) override; // TODO: as soon as we actually have a WAM host
  //  these are needed void EndInformHostOfParamChangeFromUI(int paramIdx) override; // TODO: as soon as we actually
  //  have a WAM host these are needed
