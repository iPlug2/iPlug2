 ...
 * This is the UI module that works with IPlugHybridDSP.
 ...
 *
 * @ingroup APIClasses */
class IPlugHybridUI : public IPlugAPIBase
{
public:
  IPlugHybridUI(const InstanceInfo& info, const Config& config);
...
IPlugHybridUI* MakePlug(const InstanceInfo& info);
