...
#define FAUST_TIMER_INTERVAL 2000
...
public:
   ...
   * @param sourceStr A string representing the faust source code to compile. Leave the string empty to compile based on a .dsp file on disc (pass in the constructor or via \todo)
  ...
  void Init(int oversampling = 1, int maxNInputs = -1, int maxNOutputs = -1) override;
