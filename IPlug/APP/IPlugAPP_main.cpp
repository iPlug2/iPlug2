...
namespace iplug
{
	...
	{
	#ifndef APP_ALLOW_MULTIPLE_INSTANCES  // TODO: This should be a runtime option, not compile time.
		// BUNDLE_NAME used because it won't have spaces in it
