...
inline constexpr int kDeviceDS             = 0;
inline constexpr int kDeviceCoreAudio      = 0;
inline constexpr int kDeviceAlsa           = 0;
inline constexpr int kDeviceASIO           = 1;
inline constexpr int kDeviceJack           = 1;
inline constexpr int kNumBufferSizeOptions = 11;
