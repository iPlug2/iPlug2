...
#if !(IPLUG_SKIP_CPP_VERSION_CHECK)
...
// clang-format off
#if (IPLUG_EXTENDED_COMPILER_WARNINGS)

// Mark warnings as error
...
#pragma warning (error:           4502 4503      4505 4506      4508 4509      4511 4512 4513 4514 4515 4516 4517 4518 4519      4521 4522 4523           4526                4530 4531 4532 4533 4534 4535 4536 4537 4538      4540 4541 4542 4543 4544 4545 4546                4550 4551 4552 4553 4554      4556 4557 4558 4559      4561 4562      4564 4565 4566      4568 4569 4570      4572 4573      4575 4576      4578      4580 4581 4582 4583 4584 4585 4586 4587 4588 4589      4591 4592 4593 4594 4595 4596 4597 4598     )
...
// Override error setting for specific warnings
...
#define INCLUDE_DEPENDENCIES_END __pragma(warning(pop))
// clang-format on
...
// Configure and include windows.h
...
#if !(IPLUG_DONT_INCLUDE_PLATFORM_HEADER)
	...
	// Additional windows sdk headers
	// Any function using these should be encapsluated in a platform class
	#include <WindowsX.h>
	#include <commctrl.h>
	#include <shlobj.h>
	#include <shellapi.h>
	...
	#pragma pack(pop)
#endif  // IPLUG_DONT_INCLUDE_PLATFORM_HEADER \
//---------------------------------------------------------
...
{
	typedef struct Windows : public Generic
	{
	} PlatformTypes;
}  // namespace iplug::Platform
