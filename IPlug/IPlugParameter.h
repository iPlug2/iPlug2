...
#pragma mark -
  ...
  void InitBool(const char* name, bool defaultValue, const char* label = "", int flags = 0, const char* group = "",
  ...
  void InitEnum(const char* name, int defaultValue, int nEnums, const char* label = "", int flags = 0,
                const char* group = "", const char* listItems = 0, ...);
   ...
   * @param flags The parameter's flags \see IParam::EFlags
   * @param group The parameter's group */
  void InitEnum(const char* name, int defaultValue, const std::initializer_list<const char*>& listItems, int flags = 0,
                const char* group = "");
   ...
   * @param flags The parameter's flags \see IParam::EFlags
   * @param group The parameter's group */
  void InitInt(const char* name, int defaultValue, int minVal, int maxVal, const char* label = "", int flags = 0,
               const char* group = "");
   ...
   * @param unit Used by AudioUnit plugins to determine the appearance of parameters, based on the kind of data they
   * represent
   * @param displayFunc Custom display function, conforming to DisplayFunc */
  void InitDouble(const char* name, double defaultVal, double minVal, double maxVal, double step,
                  const char* label = "", int flags = 0, const char* group = "", const Shape& shape = ShapeLinear(),
                  EParamUnit unit = kUnitCustom, DisplayFunc displayFunc = nullptr);
   ...
   * @param flags The parameter's flags \see IParam::EFlags
   * @param group The parameter's group */
  void InitSeconds(const char* name, double defaultVal = 1., double minVal = 0., double maxVal = 10., double step = 0.1,
   ...
   * @param flags The parameter's flags \see IParam::EFlags
   * @param group The parameter's group */
  void InitMilliseconds(const char* name, double defaultVal = 1., double minVal = 0., double maxVal = 100.,
                        int flags = 0, const char* group = "");
   ...
   * @param flags The parameter's flags \see IParam::EFlags
   * @param group The parameter's group */
  void InitFrequency(const char* name, double defaultVal = 1000., double minVal = 0.1, double maxVal = 10000.,
                     double step = 0.1, int flags = 0, const char* group = "");
   ...
   * @param flags The parameter's flags \see IParam::EFlags
   * @param group The parameter's group */
  void InitPitch(const char* name, int defaultVal = 60, int minVal = 0, int maxVal = 128, int flags = 0,
                 const char* group = "", bool middleCisC4 = false);
   ...
   * @param flags The parameter's flags \see IParam::EFlags
   * @param group The parameter's group */
  void InitGain(const char* name, double defaultVal = 0., double minVal = -70., double maxVal = 24., double step = 0.5,
                int flags = 0, const char* group = "");
   ...
   * @param flags The parameter's flags \see IParam::EFlags
   * @param group The parameter's group */
  void InitPercentage(const char* name, double defaultVal = 0., double minVal = 0., double maxVal = 100., int flags = 0,
                      const char* group = "");
   ...
   * @param flags The parameter's flags \see IParam::EFlags
   * @param group The parameter's group */
  void InitAngleDegrees(const char* name, double defaultVal = 0., double minVal = 0., double maxVal = 360.,
                        int flags = 0, const char* group = "");
  ...
  /** Set the parameters label after creation. WARNING: if this is called after the host has queried plugin parameters,
   * the host may display the label as it was previously
   ...
   * @note This is only used for AU plugins to determine the appearance of parameters, based on the kind of data they
   * represent
   * @return EParamUnit */
...
private:
  /** A DisplayText is used to link a certain real value of the parameter with a CString. For example -70 on a decibel
   * gain parameter could instead read "-inf" */
  struct DisplayText
  {
    double mValue;
