...
#   PLUG_WIDTH_PLACEHOLDER   - Plugin UI width
#   PLUG_HEIGHT_PLACEHOLDER  - Plugin UI height
...
if(DEFINED PLUG_WIDTH_PLACEHOLDER)
  string(REPLACE "PLUG_WIDTH_PLACEHOLDER" "${PLUG_WIDTH_PLACEHOLDER}" TEMPLATE_CONTENT "${TEMPLATE_CONTENT}")
endif()

if(DEFINED PLUG_HEIGHT_PLACEHOLDER)
  string(REPLACE "PLUG_HEIGHT_PLACEHOLDER" "${PLUG_HEIGHT_PLACEHOLDER}" TEMPLATE_CONTENT "${TEMPLATE_CONTENT}")
endif()
