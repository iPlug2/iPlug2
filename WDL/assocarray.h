...
public:
  ...
  static int cmpstr(const char **a, const char **b) { int r=WDL_strcmp_logical(*a, *b, 1); return r?r:strcmp(*a,*b); }
  static int cmpistr(const char **a, const char **b) { int r=WDL_strcmp_logical(*a, *b, 0); return r?r:stricmp(*a,*b); }
