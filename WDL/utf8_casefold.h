...
foreach ($adjmap as $b1 => $fb) {
  ...
  foreach ($fb as $offs => $list) {
    ...
    foreach ($list as $b2) {
      ...
      if (isset($adj[1]) && $adj[1] != 0) $comment .= " -> " . getcpn($b1,$b2 + $adj[1]);
    }
...
static WDL_STATICFUNC_UNUSED void wdl_utf8_2byte_casefold(unsigned char &byte1, unsigned char &byte2)
{
  ...
  switch (byte1)
  {
    case 0xc2:
      switch (byte2)
      {
        case 0xb5: byte1 = 0xce; byte2 = 0xbc; break; // U+00B5 -> U+00BC
      }
    break;
    case 0xc3:
      switch (byte2)
    ...
    case 0xc6:
      switch (byte2)
      {
        ...
        case 0x86: byte1 = 0xc9; byte2 = 0x94; break; // U+0186 -> U+0194
        case 0x87: case 0x88: byte1 = 'c'; byte2 = 0; break; // U+0187, U+0188 -> 'c'
        case 0x89: byte1 = 0xc9; byte2 = 0x96; break; // U+0189 -> U+0196
        case 0x8a: case 0x8b: case 0x8c: byte1 = 'd'; byte2 = 0; break; // U+018A, U+018B, U+018C -> 'd'
        case 0x8e: byte1 = 0xc7; byte2 = 0x9d; break; // U+018E -> U+019D
        case 0x8f: byte1 = 0xc9; byte2 = 0x99; break; // U+018F -> U+0199
        case 0x90: byte1 = 0xc9; byte2 = 0x9b; break; // U+0190 -> U+019B
        case 0x91: case 0x92: byte1 = 'f'; byte2 = 0; break; // U+0191, U+0192 -> 'f'
        case 0x93: byte1 = 'g'; byte2 = 0; break; // U+0193 -> 'g'
        case 0x94: byte1 = 0xc9; byte2 = 0xa3; break; // U+0194 -> U+01A3
        case 0x96: case 0x9c: byte1 = 0xc9; byte2 += 0x13; break; // U+0196 -> U+01A9, U+019C -> U+01AF
        ...
        case 0xa6: case 0xa9: byte1 = 0xca; byte2 -= 0x26; break; // U+01A6 -> U+0180, U+01A9 -> U+0183
        ...
        case 0xb1: byte1 = 0xca; byte2 = 0x8a; break; // U+01B1 -> U+018A
        ...
        case 0xb7: byte1 = 0xca; byte2 = 0x92; break; // U+01B7 -> U+0192
    ...
    case 0xc7:
      switch (byte2)
      {
        ...
        case 0xb6: byte1 = 0xc6; byte2 = 0x95; break; // U+01F6 -> U+01D5
        case 0xb7: byte1 = 0xc6; byte2 = 0xbf; break; // U+01F7 -> U+01FF
      }
    break;
    case 0xc8:
      switch (byte2)
    ...
    case 0xc9:
      switch (byte2)
      {
        ...
        case 0x85: byte1 = 0xca; byte2 = 0x8c; break; // U+0245 -> U+024C
    ...
    case 0xcd:
      switch (byte2)
      {
        case 0x85: byte1 = 0xce; byte2 = 0xb9; break; // U+0345 -> U+0379
        case 0xb0: case 0xb2: case 0xb6: byte2 += 0x1; break; // U+0370 -> U+0371, U+0372 -> U+0373, U+0376 -> U+0377
        case 0xbf: byte1 = 0xcf; byte2 = 0xb3; break; // U+037F -> U+0373
      }
    break;
    case 0xce:
      switch (byte2)
      {
        ...
        case 0x8e: case 0x8f: byte1 = 0xcf; byte2 -= 0x1; break; // U+038E -> U+038D, U+038F -> U+038E
        ...
        case 0xa0: case 0xa1: case 0xa3: case 0xa4: case 0xa5: case 0xa6: // U+03A0 -> U+0380, U+03A1 -> U+0381, U+03A3 -> U+0383, U+03A4 -> U+0384, U+03A5 -> U+0385, U+03A6 -> U+0386
        case 0xa7: case 0xa8: case 0xa9: case 0xaa: case 0xab: byte1 = 0xcf; byte2 -= 0x20; break; // U+03A7 -> U+0387, U+03A8 -> U+0388, U+03A9 -> U+0389, U+03AA -> U+038A, U+03AB -> U+038B
      }
    break;
    case 0xcf:
      switch (byte2)
      {
        ...
        case 0x90: byte1 = 0xce; byte2 = 0xb2; break; // U+03D0 -> U+03F2
        case 0x91: byte1 = 0xce; byte2 = 0xb8; break; // U+03D1 -> U+03F8
        case 0x95: byte2 = 0x86; break; // U+03D5 -> U+03C6
        case 0x96: byte2 = 0x80; break; // U+03D6 -> U+03C0
        case 0xb0: byte1 = 0xce; byte2 = 0xba; break; // U+03F0 -> U+03FA
        case 0xb1: byte2 = 0x81; break; // U+03F1 -> U+03C1
        case 0xb4: byte1 = 0xce; byte2 = 0xb8; break; // U+03F4 -> U+03F8
        case 0xb5: byte1 = 0xce; break; // U+03F5
        case 0xb9: byte2 = 0xb2; break; // U+03F9 -> U+03F2
        case 0xbd: case 0xbe: case 0xbf: byte1 = 0xcd; byte2 -= 0x2; break; // U+03FD -> U+03FB, U+03FE -> U+03FC, U+03FF -> U+03FD
      }
    break;
    case 0xd0:
      switch (byte2)
      {
        case 0x80: case 0x81: case 0x82: case 0x83: case 0x84: case 0x85: // U+0400 -> U+0410, U+0401 -> U+0411, U+0402 -> U+0412, U+0403 -> U+0413, U+0404 -> U+0414, U+0405 -> U+0415
        case 0x86: case 0x87: case 0x88: case 0x89: case 0x8a: case 0x8b: case 0x8c: // U+0406 -> U+0416, U+0407 -> U+0417, U+0408 -> U+0418, U+0409 -> U+0419, U+040A -> U+041A, U+040B -> U+041B, U+040C -> U+041C
        case 0x8d: case 0x8e: case 0x8f: byte1 = 0xd1; byte2 += 0x10; break; // U+040D -> U+041D, U+040E -> U+041E, U+040F -> U+041F
        ...
        case 0xa0: case 0xa1: case 0xa2: case 0xa3: case 0xa4: case 0xa5: // U+0420 -> U+0400, U+0421 -> U+0401, U+0422 -> U+0402, U+0423 -> U+0403, U+0424 -> U+0404, U+0425 -> U+0405
        case 0xa6: case 0xa7: case 0xa8: case 0xa9: case 0xaa: case 0xab: case 0xac: // U+0426 -> U+0406, U+0427 -> U+0407, U+0428 -> U+0408, U+0429 -> U+0409, U+042A -> U+040A, U+042B -> U+040B, U+042C -> U+040C
        case 0xad: case 0xae: case 0xaf: byte1 = 0xd1; byte2 -= 0x20; break; // U+042D -> U+040D, U+042E -> U+040E, U+042F -> U+040F
      }
    break;
    case 0xd1:
      switch (byte2)
    ...
    case 0xd4:
      switch (byte2)
      {
        ...
        case 0xb1: case 0xb2: case 0xb3: case 0xb4: case 0xb5: case 0xb6: // U+0531 -> U+0521, U+0532 -> U+0522, U+0533 -> U+0523, U+0534 -> U+0524, U+0535 -> U+0525, U+0536 -> U+0526
        case 0xb7: case 0xb8: case 0xb9: case 0xba: case 0xbb: case 0xbc: case 0xbd: // U+0537 -> U+0527, U+0538 -> U+0528, U+0539 -> U+0529, U+053A -> U+052A, U+053B -> U+052B, U+053C -> U+052C, U+053D -> U+052D
        case 0xbe: case 0xbf: byte1 = 0xd5; byte2 -= 0x10; break; // U+053E -> U+052E, U+053F -> U+052F
      }
    break;
    case 0xd5:
      switch (byte2)
      {
        ...
        case 0x90: case 0x91: case 0x92: case 0x93: case 0x94: case 0x95: // U+0550 -> U+0540, U+0551 -> U+0541, U+0552 -> U+0542, U+0553 -> U+0543, U+0554 -> U+0544, U+0555 -> U+0545
        case 0x96: byte1 = 0xd6; byte2 -= 0x10; break; // U+0556 -> U+0546
      }
    break;
  }
}
