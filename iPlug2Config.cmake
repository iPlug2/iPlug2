...
function(iplug2_configure_target target target_type)
    ...
    elseif (${target_type} STREQUAL "vst3")
        ...
        if (WIN32)
            addS(vst3_sdk_src "${sdk2}/main/dllmain.cpp;${sdk2}/main/pluginfactory.cpp;")

            # After building, we run the post-build script
            add_custom_command(TARGET ${target}
                POST_BUILD
                COMMAND ${post_build_script} ARGS 
                    "\".vst3\"" "${IPLUG2_CONFIG_APP_NAME}" "\"${PROCESSOR_ARCH}\"" "1" "\$(TargetPath)"
