...
def main():
  ...
  if(process_resource):
    resource_h = open(projectpath + "/source/resource.h", "w")
...
#   resource_h.write("// END_FRAMES\n")
  ...
  for line in fileinput.input(projectpath + "/source/config.h",inplace=0):
  ...
  if(process_resource):
    ...
    rc.write("AboutBox_ID PNG AboutBox_FN\n")
    rc.write("Background_Main_ID PNG Background_Main_FN\n")
    rc.write("Detune_Oct_ID PNG Detune_Oct_FN\n")
    rc.write("Detune_Polarity_ID PNG Detune_Polarity_FN\n")
    rc.write("Detune_Semi_ID PNG Detune_Semi_FN\n")
    rc.write("Env_ADSRPanel_ID PNG Env_ADSRPanel_FN\n")
    rc.write("Env_EndPoint_ID PNG Env_EndPoint_FN\n")
    rc.write("Env_Loop_ID PNG Env_Loop_FN\n")
    rc.write("Env_Slider_ID PNG Env_Slider_FN\n")
    rc.write("Env_SustainPoint_ID PNG Env_SustainPoint_FN\n")
    rc.write("Font_LCD_ID PNG Font_LCD_FN\n")
    rc.write("Font_Presets_ID PNG Font_Presets_FN\n")
    rc.write("Master_EnvMode_ID PNG Master_EnvMode_FN\n")
    rc.write("Master_MixMode_ID PNG Master_MixMode_FN\n")
    rc.write("Master_ModMode_ID PNG Master_ModMode_FN\n")
    rc.write("Master_PitchbendRange_ID PNG Master_PitchbendRange_FN\n")
    rc.write("Master_PolyMode_ID PNG Master_PolyMode_FN\n")
    rc.write("MIDIActivityLed_ID PNG MIDIActivityLed_FN\n")
    rc.write("OctaveShift_ID PNG OctaveShift_FN\n")
    rc.write("Osc_Shape_ID PNG Osc_Shape_FN\n")
    rc.write("Osc_Shape_Dual_ID PNG Osc_Shape_Dual_FN\n")
    rc.write("Pan_Lock_ID PNG Pan_Lock_FN\n")
    rc.write("Preset_File_ID PNG Preset_File_FN\n")
    rc.write("Preset_Next_ID PNG Preset_Next_FN\n")
    rc.write("Preset_Prev_ID PNG Preset_Prev_FN\n")
    rc.write("Preset_Store_ID PNG Preset_Store_FN\n")
    rc.write("Preset_Tools_ID PNG Preset_Tools_FN\n")
    rc.write("Scaling_AftertouchMode_ID PNG Scaling_AftertouchMode_FN\n")
    rc.write("Scaling_Curve_ID PNG Scaling_Curve_FN\n")
    rc.write("Scaling_Down_ID PNG Scaling_Down_FN\n")
    rc.write("Scaling_Edit_ID PNG Scaling_Edit_FN\n")
    rc.write("Scaling_Left_ID PNG Scaling_Left_FN\n")
    rc.write("Scaling_Lin_ID PNG Scaling_Lin_FN\n")
    rc.write("Scaling_LoadTun_ID PNG Scaling_LoadTun_FN\n")
    rc.write("Scaling_Lock_ID PNG Scaling_Lock_FN\n")
    rc.write("Scaling_Max_ID PNG Scaling_Max_FN\n")
    rc.write("Scaling_Panel_ID PNG Scaling_Panel_FN\n")
    rc.write("Scaling_ResetTun_ID PNG Scaling_ResetTun_FN\n")
    rc.write("Scaling_Right_ID PNG Scaling_Right_FN\n")
    rc.write("Scaling_Up_ID PNG Scaling_Up_FN\n")
    rc.write("SmallKnob_ID PNG SmallKnob_FN\n")
    rc.write("SmallKnobRim_ID PNG SmallKnobRim_FN\n")
    rc.write("Vibrato_RateMode_ID PNG Vibrato_RateMode_FN\n")
    rc.write("Vibrato_Shape_ID PNG Vibrato_Shape_FN\n")
    rc.write("Vibrato_SyncMode_ID PNG Vibrato_SyncMode_FN\n")
    rc.write("LCDBG_ID PNG LCDBG_FN\n")
