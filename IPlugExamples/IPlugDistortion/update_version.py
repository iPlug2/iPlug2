...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugDistortion-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugDistortion-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugDistortion-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugDistortion-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugDistortion-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugDistortion-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/IPlugDistortion-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/IPlugDistortion.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugDistortion.iss",inplace=1):
