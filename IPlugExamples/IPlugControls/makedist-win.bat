...
:32-Bit-is
"%ProgramFiles%\Inno Setup 5\iscc" /cc ".\installer\IPlugControls.iss"
goto END-is

:64-Bit-is
"%ProgramFiles(x86)%\Inno Setup 5\iscc" /cc ".\installer\IPlugControls.iss"
goto END-is

:END-is

REM - ZIP
REM - "%ProgramFiles%\7-Zip\7z.exe" a .\installer\IPlugControls-win-32bit.zip .\build-win\app\win32\bin\IPlugControls.exe .\build-win\vst3\win32\bin\IPlugControls.vst3 .\build-win\vst2\win32\bin\IPlugControls.dll .\build-win\rtas\bin\IPlugControls.dpm .\build-win\rtas\bin\IPlugControls.dpm.rsr .\build-win\aax\bin\IPlugControls.aaxplugin* .\installer\license.rtf .\installer\readmewin.rtf
REM - "%ProgramFiles%\7-Zip\7z.exe" a .\installer\IPlugControls-win-64bit.zip .\build-win\app\x64\bin\IPlugControls.exe .\build-win\vst3\x64\bin\IPlugControls.vst3 .\build-win\vst2\x64\bin\IPlugControls.dll .\installer\license.rtf .\installer\readmewin.rtf
