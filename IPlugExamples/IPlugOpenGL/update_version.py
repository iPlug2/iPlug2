...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugOpenGL-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugOpenGL-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugOpenGL-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugOpenGL-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugOpenGL-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugOpenGL-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/IPlugOpenGL-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/IPlugOpenGL.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugOpenGL.iss",inplace=1):
