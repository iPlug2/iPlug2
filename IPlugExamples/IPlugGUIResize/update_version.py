...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugGUIResize-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugGUIResize-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugGUIResize-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugGUIResize-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugGUIResize-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugGUIResize-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/IPlugGUIResize-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/IPlugGUIResize.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugGUIResize.iss",inplace=1):
