...
# this script will update the versions in plist and installer files to match that in 
...
def main():
  ...
  for line in fileinput.input(scriptpath + "/",inplace=0):
  ...
  plistpath = scriptpath + "/resources/IPlugEffectCairo-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugEffectCairo-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugEffectCairo-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugEffectCairo-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugEffectCairo-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/IPlugEffectCairo.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugEffectCairo.iss",inplace=1):
