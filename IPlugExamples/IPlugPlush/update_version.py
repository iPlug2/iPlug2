...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugPlush-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugPlush-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugPlush-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugPlush-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugPlush-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugPlush-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/IPlugPlush-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/IPlugPlush.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugPlush.iss",inplace=1):
