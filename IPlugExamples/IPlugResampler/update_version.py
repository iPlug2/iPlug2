...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugResampler-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugResampler-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugResampler-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugResampler-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugResampler-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugResampler-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/IPlugResampler-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/IPlugResampler.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugResampler.iss",inplace=1):
