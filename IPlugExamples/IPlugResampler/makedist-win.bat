...
call ashelper -f .\build-win\aax\bin\IPlugResampler.aaxplugin\Contents\Win32\IPlugResampler.aaxplugin -l .\..\..\..\Certificates\aax.crt -k .\..\..\..\Certificates\aax.key -o .\build-win\aax\bin\IPlugResampler.aaxplugin\Contents\Win32\IPlugResampler.aaxplugin
REM - call ashelper -f .\build-win\aax\bin\IPlugResampler.aaxplugin\Contents\x64\IPlugResampler.aaxplugin -l .\..\..\..\Certificates\aax.crt -k .\..\..\..\Certificates\aax.key -o .\build-win\aax\bin\IPlugResampler.aaxplugin\Contents\x64\IPlugResampler.aaxplugin
