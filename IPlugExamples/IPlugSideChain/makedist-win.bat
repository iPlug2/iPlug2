...
REM - call ashelper -f .\build-win\aax\bin\IPlugSideChain.aaxplugin\Contents\x64\IPlugSideChain.aaxplugin -l .\..\..\..\Certificates\aax.crt -k .\..\..\..\Certificates\aax.key -o .\build-win\aax\bin\IPlugSideChain.aaxplugin\Contents\x64\IPlugSideChain.aaxplugin
