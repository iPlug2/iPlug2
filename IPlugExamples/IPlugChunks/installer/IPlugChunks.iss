...
Source: "..\build-win\aax\bin\IPlugChunks.aaxplugin\*.*"; DestDir: "{cf}\Avid\Audio\Plug-Ins\IPlugChunks.aaxplugin\"; Components:aax_64; Flags: ignoreversion recursesubdirs;
...
Name: "{group}\User guide"; Filename: "{app}\IPlugChunks_manual.pdf"
