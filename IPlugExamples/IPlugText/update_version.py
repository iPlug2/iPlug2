...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugText-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugText-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugText-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugText-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugText-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugText-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/IPlugText-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/IPlugText.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugText.iss",inplace=1):
