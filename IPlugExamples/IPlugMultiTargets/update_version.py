...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugMultiTargets-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugMultiTargets-AAX-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/IPlugMultiTargets.pkgproj"
