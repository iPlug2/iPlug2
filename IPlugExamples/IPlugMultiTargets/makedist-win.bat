...
REM - msbuild IPlugMultiTargets-app.vcxproj /p:configuration=release /p:platform=win32
...
:32-Bit-is
"%ProgramFiles%\Inno Setup 5\iscc" /cc ".\installer\IPlugMultiTargets.iss"
goto END-is

:64-Bit-is
"%ProgramFiles(x86)%\Inno Setup 5\iscc" /cc ".\installer\IPlugMultiTargets.iss"
goto END-is

:END-is

REM - ZIP
REM - "%ProgramFiles%\7-Zip\7z.exe" a .\installer\IPlugMultiTargets-win-32bit.zip .\build-win\app\win32\bin\IPlugMultiTargets.exe .\build-win\vst3\win32\bin\IPlugMultiTargets.vst3 .\build-win\vst2\win32\bin\IPlugMultiTargets.dll .\build-win\rtas\bin\IPlugMultiTargets.dpm .\build-win\rtas\bin\IPlugMultiTargets.dpm.rsr .\build-win\aax\bin\IPlugMultiTargets.aaxplugin* .\installer\license.rtf .\installer\readmewin.rtf
REM - "%ProgramFiles%\7-Zip\7z.exe" a .\installer\IPlugMultiTargets-win-64bit.zip .\build-win\app\x64\bin\IPlugMultiTargets.exe .\build-win\vst3\x64\bin\IPlugMultiTargets.vst3 .\build-win\vst2\x64\bin\IPlugMultiTargets.dll .\installer\license.rtf .\installer\readmewin.rtf
