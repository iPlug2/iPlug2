...
goto END
:END
REM - msbuild IPlugMultiTargets.vcxproj /p:configuration=release /p:platform=win32
REM - msbuild IPlugMultiTargets-app.vcxproj /p:configuration=release /p:platform=win32
REM - msbuild IPlugMultiTargets.vcxproj /p:configuration=release /p:platform=x64
REM - msbuild IPlugMultiTargets-app.vcxproj /p:configuration=release /p:platform=x64

msbuild IPlugMultiTargets.sln /p:configuration=release /p:platform=win32
msbuild IPlugMultiTargets.sln /p:configuration=release /p:platform=x64
