...
VST2=${VST2//\VST_FOLDER = }/IPlugMultiTargets.vst

VST3=`echo | grep VST3_FOLDER ../../common.xcconfig`
VST3=${VST3//\VST3_FOLDER = }/IPlugMultiTargets.vst3

AU=`echo | grep AU_FOLDER ../../common.xcconfig`
AU=${AU//\AU_FOLDER = }/IPlugMultiTargets.component

APP=`echo | grep APP_FOLDER ../../common.xcconfig`
APP=${APP//\APP_FOLDER = }/IPlugMultiTargets.app

# Dev build folder
RTAS=`echo | grep RTAS_FOLDER ../../common.xcconfig`
RTAS=${RTAS//\RTAS_FOLDER = }/IPlugMultiTargets.dpm
RTAS_FINAL="/Library/Application Support/Digidesign/Plug-Ins/IPlugMultiTargets.dpm"

# Dev build folder
AAX=`echo | grep AAX_FOLDER ../../common.xcconfig`
AAX=${AAX//\AAX_FOLDER = }/IPlugMultiTargets.aaxplugin
AAX_FINAL="/Library/Application Support/Avid/Audio/Plug-Ins/IPlugMultiTargets.aaxplugin"

PKG='installer/build-mac/IPlugMultiTargets Installer.pkg'
PKG_US='installer/build-mac/IPlugMultiTargets Installer.unsigned.pkg'
...
xcodebuild -project IPlugMultiTargets.xcodeproj -xcconfig IPlugMultiTargets.xcconfig -target "All" -configuration Release 2> ./build-mac.log
...
echo "setting icons"
echo ""
setfileicon resources/IPlugMultiTargets.icns $AU
...
setfileicon resources/IPlugMultiTargets.icns "${AAX}"
...
sudo ashelper -f "${AAX_FINAL}/Contents/MacOS/IPlugMultiTargets" -l ../../../Certificates/aax.crt -k ../../../Certificates/aax.key -o "${AAX_FINAL}/Contents/MacOS/IPlugMultiTargets"
#---------------------------------------------------------------------------------------------------------
...
# echo ""
# codesign -f -s "3rd Party Mac Developer Application: ""${CERT_ID}" $APP --entitlements resources/IPlugMultiTargets.entitlements
#  
...
sudo sudo rm -R -f installer/IPlugMultiTargets-mac.dmg

echo "building installer"
echo ""
packagesbuild installer/IPlugMultiTargets.pkgproj
...
#set installer icon
setfileicon resources/IPlugMultiTargets.icns "${PKG}"
...
then
  ...
  sudo rm -R -f installer/IPlugMultiTargets.dmg
fi
...
# echo ""
# cp -R $AU installer/dist/IPlugMultiTargets.component
...
# cp -R $AAX installer/dist/IPlugMultiTargets.aaxplugin
