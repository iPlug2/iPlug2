...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugMultiChannel-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugMultiChannel-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugMultiChannel-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugMultiChannel-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugMultiChannel-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugMultiChannel-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/IPlugMultiChannel-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/IPlugMultiChannel.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugMultiChannel.iss",inplace=1):
