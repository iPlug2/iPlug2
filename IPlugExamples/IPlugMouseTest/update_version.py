...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugMouseTest-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugMouseTest-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugMouseTest-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugMouseTest-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugMouseTest-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugMouseTest-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/IPlugMouseTest-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/IPlugMouseTest.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugMouseTest.iss",inplace=1):
