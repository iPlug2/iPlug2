...
VST2=${VST2//\VST_FOLDER = }/IPlugMouseTest.vst

VST3=`echo | grep VST3_FOLDER ../../common.xcconfig`
VST3=${VST3//\VST3_FOLDER = }/IPlugMouseTest.vst3

AU=`echo | grep AU_FOLDER ../../common.xcconfig`
AU=${AU//\AU_FOLDER = }/IPlugMouseTest.component

APP=`echo | grep APP_FOLDER ../../common.xcconfig`
APP=${APP//\APP_FOLDER = }/IPlugMouseTest.app

# Dev build folder
RTAS=`echo | grep RTAS_FOLDER ../../common.xcconfig`
RTAS=${RTAS//\RTAS_FOLDER = }/IPlugMouseTest.dpm
RTAS_FINAL="/Library/Application Support/Digidesign/Plug-Ins/IPlugMouseTest.dpm"

# Dev build folder
AAX=`echo | grep AAX_FOLDER ../../common.xcconfig`
AAX=${AAX//\AAX_FOLDER = }/IPlugMouseTest.aaxplugin
AAX_FINAL="/Library/Application Support/Avid/Audio/Plug-Ins/IPlugMouseTest.aaxplugin"

PKG='installer/build-mac/IPlugMouseTest Installer.pkg'
PKG_US='installer/build-mac/IPlugMouseTest Installer.unsigned.pkg'
...
xcodebuild -project IPlugMouseTest.xcodeproj -xcconfig IPlugMouseTest.xcconfig -target "All" -configuration Release 2> ./build-mac.log
...
echo "setting icons"
echo ""
setfileicon resources/IPlugMouseTest.icns $AU
...
setfileicon resources/IPlugMouseTest.icns "${AAX}"
...
sudo ashelper -f "${AAX_FINAL}/Contents/MacOS/IPlugMouseTest" -l ../../../Certificates/aax.crt -k ../../../Certificates/aax.key -o "${AAX_FINAL}/Contents/MacOS/IPlugMouseTest"
#---------------------------------------------------------------------------------------------------------
...
# echo ""
# codesign -f -s "3rd Party Mac Developer Application: ""${CERT_ID}" $APP --entitlements resources/IPlugMouseTest.entitlements
#  
...
echo ""
packagesbuild installer/IPlugMouseTest.pkgproj
...
#set installer icon
setfileicon resources/IPlugMouseTest.icns "${PKG}"
...
then
  ...
  sudo rm -R -f installer/IPlugMouseTest.dmg
fi
...
# echo ""
# cp -R $AU installer/dist/IPlugMouseTest.component
...
# cp -R $AAX installer/dist/IPlugMouseTest.aaxplugin
