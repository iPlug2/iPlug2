...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugMidiEffect Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugMidiEffect Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugMidiEffect Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugMidiEffect installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugMidiEffect Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugMidiEffect installer\n"
