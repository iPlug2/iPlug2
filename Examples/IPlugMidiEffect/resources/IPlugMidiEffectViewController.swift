/*
  This is the initial ios app extension view controller, which is referenced by IPlugMidiEffect-iOS-MainInterface storyboard
*/

import UIKit
import CoreAudioKit

public class IPlugMidiEffectViewController: AUViewController {
  ...
  func connectViewWithAU() {
    // To use the generic UI (swift), change the view in IPlugMidiEffect-iOS-MainInterface.storyboard to custom class: GenericUI  module: IPlugMidiEffectFramework
