/*
  This is the initial ios app extension view controller, which is referenced by IPlugInstrument-iOS-MainInterface storyboard
*/

import UIKit
import CoreAudioKit

public class IPlugInstrumentViewController: AUViewController {
  ...
  func connectViewWithAU() {
    // To use the generic UI (swift), change the view in IPlugInstrument-iOS-MainInterface.storyboard to custom class: GenericUI  module: IPlugInstrumentFramework
