...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugEmbedPlatformView Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugEmbedPlatformView Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugEmbedPlatformView Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugEmbedPlatformView installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugEmbedPlatformView Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugEmbedPlatformView installer\n"
