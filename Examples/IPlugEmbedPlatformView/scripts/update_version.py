...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugEmbedPlatformView-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugEmbedPlatformView-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/IPlugEmbedPlatformView-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/IPlugEmbedPlatformView-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/IPlugEmbedPlatformView-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/IPlugEmbedPlatformView.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugEmbedPlatformView.iss",inplace=1):
