...
def  main():
  ...
  installer = "\installer\IPlugEmbedPlatformView Installer.exe"
   
  if demo:
    installer = "\installer\IPlugEmbedPlatformView Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\IPlugEmbedPlatformView manual.pdf" 
  ]
  ...
  ZIPNAME = "IPlugEmbedPlatformView-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "IPlugEmbedPlatformView-v" + FULLVERSIONSTR + "-win-demo.zip"
