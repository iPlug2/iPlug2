...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugSpectrogramDisplay-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugSpectrogramDisplay-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/IPlugSpectrogramDisplay-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/IPlugSpectrogramDisplay-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/IPlugSpectrogramDisplay-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/IPlugSpectrogramDisplay.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugSpectrogramDisplay.iss",inplace=1):
