...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugSpectrogramDisplay Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugSpectrogramDisplay Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugSpectrogramDisplay Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugSpectrogramDisplay installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugSpectrogramDisplay Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugSpectrogramDisplay installer\n"
