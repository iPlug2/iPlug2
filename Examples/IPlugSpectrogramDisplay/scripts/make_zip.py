...
def  main():
  ...
  installer = "\installer\IPlugSpectrogramDisplay Installer.exe"
   
  if demo:
    installer = "\installer\IPlugSpectrogramDisplay Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\IPlugSpectrogramDisplay manual.pdf" 
  ]
  ...
  ZIPNAME = "IPlugSpectrogramDisplay-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "IPlugSpectrogramDisplay-v" + FULLVERSIONSTR + "-win-demo.zip"
