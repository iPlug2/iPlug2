...
def  main():
  ...
  installer = "\installer\IPlugReaperPlugin Installer.exe"
   
  if demo:
    installer = "\installer\IPlugReaperPlugin Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\IPlugReaperPlugin manual.pdf" 
  ]
  ...
  ZIPNAME = "IPlugReaperPlugin-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "IPlugReaperPlugin-v" + FULLVERSIONSTR + "-win-demo.zip"
