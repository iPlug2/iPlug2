...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugResponsiveUI-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugResponsiveUI-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugResponsiveUI-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugResponsiveUI-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugResponsiveUI-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/IPlugResponsiveUI.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugResponsiveUI.iss",inplace=1):
