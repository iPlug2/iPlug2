...
def  main():
  ...
  installer = "\installer\IPlugResponsiveUI Installer.exe"
   
  if demo:
    installer = "\installer\IPlugResponsiveUI Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\IPlugResponsiveUI manual.pdf" 
  ]
  ...
  ZIPNAME = "IPlugResponsiveUI-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "IPlugResponsiveUI-v" + FULLVERSIONSTR + "-win-demo.zip"
