...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright OliLarkin, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/ReaperPlugin-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ReaperPlugin-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ReaperPlugin-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ReaperPlugin-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ReaperPlugin-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/ReaperPlugin.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/ReaperPlugin.iss",inplace=1):
