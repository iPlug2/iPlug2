...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugUIKit-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugUIKit-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugUIKit-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugUIKit-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugUIKit-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/IPlugUIKit.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugUIKit.iss",inplace=1):
