...
// Copied from the elements basic_sliders_and_knobs example
...
{
  auto view = std::make_unique<cycfi::elements::view>((host_view_handle) pParent);
  ...
  link_controls(*view); // Link the controls.
