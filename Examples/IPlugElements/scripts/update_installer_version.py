...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugElements Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugElements Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugElements Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugElements installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugElements Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugElements installer\n"
