...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugMetalCPP Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugMetalCPP Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugMetalCPP Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugMetalCPP installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugMetalCPP Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugMetalCPP installer\n"
