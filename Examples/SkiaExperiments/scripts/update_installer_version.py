...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=SkiaExperiments Demo Installer\n"
      else:
        line="OutputBaseFilename=SkiaExperiments Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the SkiaExperiments Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the SkiaExperiments installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=SkiaExperiments Demo installer\n"
     else:
       line="SetupWindowTitle=SkiaExperiments installer\n"
