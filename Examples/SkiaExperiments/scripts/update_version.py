...
def main():
  ...
  plistpath = scriptpath + "/resources/SkiaExperiments-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SkiaExperiments-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SkiaExperiments-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SkiaExperiments-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SkiaExperiments-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/SkiaExperiments.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/SkiaExperiments.iss",inplace=1):
