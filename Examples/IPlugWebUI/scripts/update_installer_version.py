...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugWebUI Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugWebUI Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugWebUI Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugWebUI installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugWebUI Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugWebUI installer\n"
