...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugSvelteUI Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugSvelteUI Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugSvelteUI Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugSvelteUI installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugSvelteUI Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugSvelteUI installer\n"
