/*
  This is the initial ios app extension view controller, which is referenced by IPlugFaustDSP-iOS-MainInterface storyboard
*/

import UIKit
import CoreAudioKit

public class IPlugFaustDSPViewController: AUViewController {
