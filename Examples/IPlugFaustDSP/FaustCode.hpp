...
class Faust1SIG0 {
  ...
  public:
	...
	void instanceInitFaust1SIG0(int samplingFreq) {
	...
	void fillFaust1SIG0(int count, float* output) {
...
class Faust1 : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "IPlugFaustDSP");
	...
	static void classInit(int samplingFreq) {
		...
		sig0->instanceInitFaust1SIG0(samplingFreq);
