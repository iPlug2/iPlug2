...
const unsigned char TEST_PNG[170] = {
	...
	0x00, 0x00, 0x3F, 0x49, 0x44, 0x41, 0x54, 0x18, 0x57, 0x01, 0x34, 0x00,
	0xCB, 0xFF, 0x00, 0xCF, 0xCF, 0xCF, 0xB1, 0xB1, 0xB1, 0xEE, 0xEE, 0xEE,
	0xFF, 0xFF, 0xFF, 0x03, 0x1F, 0x1F, 0x1F, 0xAF, 0xAF, 0xAF, 0x0B, 0x0B,
	0x0B, 0x26, 0x26, 0x26, 0x02, 0x2F, 0x2F, 0x2F, 0x05, 0x05, 0x05, 0xD2,
	0xD2, 0xD2, 0xE6, 0xE6, 0xE6, 0x01, 0xF8, 0xF8, 0xF8, 0xD3, 0xD3, 0xD3,
	0x0E, 0x0E, 0x0E, 0x22, 0x22, 0x22, 0xCD, 0x39, 0x19, 0x00, 0x9A, 0x20,
	0x19, 0x58, 0x00, 0x00, 0x00, 0x00, 0x49, 0x45, 0x4E, 0x44, 0xAE, 0x42,
	0x60, 0x82
};


Testing::Testing(const InstanceInfo& info)
...
//    pGraphics->EnableLiveEdit(true);
    ...
    auto bmp = pGraphics->LoadBitmap("test1.png", TEST_PNG, 170);
    pGraphics->AttachControl(new IBitmapControl(2, 2, bmp));
...
#if IPLUG_DSP
void Testing::ProcessBlock(sample** inputs, sample** outputs, int nFrames)
{
...
void Testing::OnReset()
{
  mDSP.Reset(GetSampleRate(), GetBlockSize());
}

void Testing::ProcessMidiMsg(const IMidiMsg& msg)
{
  TRACE;
...
void Testing::OnParamChange(int paramIdx)
{
  mDSP.SetParam(paramIdx, GetParam(paramIdx)->Value());
}

bool Testing::OnMessage(int msgTag, int ctrlTag, int dataSize, const void* pData)
{
