...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Testing Demo Installer\n"
      else:
        line="OutputBaseFilename=Testing Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Testing Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Testing installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Testing Demo installer\n"
     else:
       line="SetupWindowTitle=Testing installer\n"
