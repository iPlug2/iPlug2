...
def main():
  ...
  plistpath = scriptpath + "/resources/Testing-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Testing-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Testing-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Testing-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Testing-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Testing.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Testing.iss",inplace=1):
