...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugSpectFFT Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugSpectFFT Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugSpectFFT Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugSpectFFT installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugSpectFFT Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugSpectFFT installer\n"
