...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugSpectFFT-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugSpectFFT-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugSpectFFT-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugSpectFFT-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugSpectFFT-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/IPlugSpectFFT.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugSpectFFT.iss",inplace=1):
