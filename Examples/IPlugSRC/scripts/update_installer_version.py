...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugSRC Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugSRC Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugSRC Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugSRC installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugSRC Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugSRC installer\n"
