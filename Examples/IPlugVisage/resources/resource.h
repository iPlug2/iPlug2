// Shared resource IDs used by the iPlug2 standalone host and native resources.
// Keep the debug command IDs: shared host code references them with NO_IGRAPHICS.
