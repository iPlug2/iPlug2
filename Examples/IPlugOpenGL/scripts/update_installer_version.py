...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugOpenGL Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugOpenGL Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugOpenGL Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugOpenGL installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugOpenGL Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugOpenGL installer\n"
