...
# By default, that is three directories up from /Examples/IPlugVisualizer/config
IPLUG2_ROOT = ../../..

include ../../../common-wasm.mk

SRC += $(PROJECT_ROOT)/IPlugVisualizer.cpp

# FFT library for spectrum analyzer (DSP side only)
