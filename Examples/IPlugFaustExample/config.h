#define PLUG_NAME "IPlugFaustExample"
...
#define PLUG_CLASS_NAME IPlugFaustExample

#define BUNDLE_NAME "IPlugFaustExample"
...
#define AUV2_ENTRY IPlugFaustExample_Entry
#define AUV2_ENTRY_STR "IPlugFaustExample_Entry"
#define AUV2_FACTORY IPlugFaustExample_Factory
#define AUV2_VIEW_CLASS IPlugFaustExample_View
#define AUV2_VIEW_CLASS_STR "IPlugFaustExample_View"

#define AAX_TYPE_IDS 'EFN1', 'EFN2'
#define AAX_TYPE_IDS_AUDIOSUITE 'EFA1', 'EFA2'
#define AAX_PLUG_MFR_STR "AcmeInc\nAcmeInc\nAcme"
#define AAX_PLUG_NAME_STR "IPlugFaustExample\nIPEF"
