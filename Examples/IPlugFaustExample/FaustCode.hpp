 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			output0[i] = FAUSTFLOAT(ftbl0DistortionSIG0[int((65536.0f * fRec1[0]))]);
...
class Faust_Distortion : public IPlugFaust
{
public:
	Faust_Distortion(const char* name, const char* inputDSPFile = 0, int nVoices = 1, int rate = 1,
