...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugFaustExample-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugFaustExample-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugFaustExample-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugFaustExample-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugFaustExample-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/IPlugFaustExample.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugFaustExample.iss",inplace=1):
