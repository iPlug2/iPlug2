/*
  This is the initial ios app extension view controller, which is referenced by IPlugFaustExample-iOS-MainInterface storyboard
*/

import UIKit
import CoreAudioKit

public class IPlugFaustExampleViewController: AUViewController {
