...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugShaderTest Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugShaderTest Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugShaderTest Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugShaderTest installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugShaderTest Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugShaderTest installer\n"
