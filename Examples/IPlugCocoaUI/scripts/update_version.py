...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugCocoaUI-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugCocoaUI-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugCocoaUI-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugCocoaUI-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugCocoaUI-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/IPlugCocoaUI.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugCocoaUI.iss",inplace=1):
