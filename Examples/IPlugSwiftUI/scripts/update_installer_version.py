...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugSwiftUI Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugSwiftUI Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugSwiftUI Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugSwiftUI installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugSwiftUI Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugSwiftUI installer\n"
