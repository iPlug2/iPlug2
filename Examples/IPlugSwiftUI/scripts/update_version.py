...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugSwiftUI-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugSwiftUI-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugSwiftUI-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugSwiftUI-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugSwiftUI-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/IPlugSwiftUI.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugSwiftUI.iss",inplace=1):
