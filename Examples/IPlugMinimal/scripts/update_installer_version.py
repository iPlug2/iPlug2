...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugMinimal Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugMinimal Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugMinimal Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugMinimal installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugMinimal Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugMinimal installer\n"
