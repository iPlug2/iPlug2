...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugMinimal-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugMinimal-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugMinimal-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugMinimal-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugMinimal-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/IPlugMinimal.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugMinimal.iss",inplace=1):
