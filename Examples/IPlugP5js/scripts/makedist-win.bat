...
if %1 == 1 (echo Making IPlugP5js Windows DEMO VERSION distribution ...) else (echo Making IPlugP5js Windows FULL VERSION distribution ...)
...
REM - msbuild IPlugP5js-app.vcxproj /p:configuration=release /p:platform=win32

echo Building 32 bit binaries...
msbuild IPlugP5js.sln /p:configuration=release /p:platform=win32 /nologo /verbosity:minimal /fileLogger /m /flp:logfile=build-win.log;errorsonly 

echo Building 64 bit binaries...
msbuild IPlugP5js.sln /p:configuration=release /p:platform=x64 /nologo /verbosity:minimal /fileLogger /m /flp:logfile=build-win.log;errorsonly;append
...
REM --wraptool sign --verbose --account XXXXX --wcguid XXXXX --keyfile XXXXX.p12 --keypassword XXXXX --in .\build-win\aax\bin\IPlugP5js.aaxplugin\Contents\Win32\IPlugP5js.aaxplugin --out .\build-win\aax\bin\IPlugP5js.aaxplugin\Contents\Win32\IPlugP5js.aaxplugin
REM --wraptool sign --verbose --account XXXXX --wcguid XXXXX --keyfile XXXXX.p12 --keypassword XXXXX --in .\build-win\aax\bin\IPlugP5js.aaxplugin\Contents\x64\IPlugP5js.aaxplugin --out .\build-win\aax\bin\IPlugP5js.aaxplugin\Contents\x64\IPlugP5js.aaxplugin
...
:32-Bit-is
"%ProgramFiles%\Inno Setup 5\iscc" /Q /cc ".\installer\IPlugP5js.iss"
goto END-is

:64-Bit-is
"%ProgramFiles(x86)%\Inno Setup 5\iscc" /Q /cc ".\installer\IPlugP5js.iss"
goto END-is

:END-is

REM - Codesign Installer for Windows 8+
REM -"C:\Program Files (x86)\Microsoft SDKs\Windows\v7.1A\Bin\signtool.exe" sign /f "XXXXX.p12" /p XXXXX /d "IPlugP5js Installer" ".\installer\IPlugP5js Installer.exe"

REM -if %1 == 1 (
REM -copy ".\installer\IPlugP5js Installer.exe" ".\installer\IPlugP5js Demo Installer.exe"
REM -del ".\installer\IPlugP5js Installer.exe"
REM -)
