...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugScopeControl Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugScopeControl Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugScopeControl Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugScopeControl installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugScopeControl Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugScopeControl installer\n"
