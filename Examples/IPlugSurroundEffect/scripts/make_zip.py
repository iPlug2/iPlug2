...
def  main():
  ...
  installer = "\installer\IPlugSurroundEffect Installer.exe"
   
  if demo:
    installer = "\installer\IPlugSurroundEffect Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\IPlugSurroundEffect manual.pdf" 
  ]
  ...
  ZIPNAME = "IPlugSurroundEffect-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "IPlugSurroundEffect-v" + FULLVERSIONSTR + "-win-demo.zip"
