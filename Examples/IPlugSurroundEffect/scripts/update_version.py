...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugSurroundEffect-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugSurroundEffect-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/IPlugSurroundEffect-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/IPlugSurroundEffect-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/IPlugSurroundEffect-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/IPlugSurroundEffect.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugSurroundEffect.iss",inplace=1):
