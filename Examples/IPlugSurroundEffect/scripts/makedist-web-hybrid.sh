...
PROJECT_NAME=IPlugSurroundEffect
...
if [ -d build-web-hybrid/.git ]; then
  ...
  mkdir build-web-hybrid
fi

mkdir -p build-web-hybrid/scripts
mkdir -p build-web-hybrid/styles

echo "============================================================"
echo "BUNDLING RESOURCES"
echo "============================================================"

rm -f ./build-web-hybrid/scripts/imgs.js
rm -f ./build-web-hybrid/scripts/imgs@2x.js
rm -f ./build-web-hybrid/scripts/svgs.js
rm -f ./build-web-hybrid/scripts/fonts.js
...
if [ -d ./resources/fonts ] && [ "$(ls -A ./resources/fonts/*.ttf 2>/dev/null)" ]; then
  ...
  mv ./fonts.js ./build-web-hybrid/scripts/fonts.js
  mv ./fonts.data ./build-web-hybrid/fonts.data
fi
...
if [ -d ./resources/img ] && [ "$(ls -A ./resources/img/*.svg 2>/dev/null)" ]; then
  ...
  mv ./svgs.js ./build-web-hybrid/scripts/svgs.js
  mv ./svgs.data ./build-web-hybrid/svgs.data
fi
...
if [ -d ./resources/img ] && [ "$(ls -A ./resources/img/*.png 2>/dev/null | grep -v @2x)" ]; then
  ...
  mv ./imgs.js ./build-web-hybrid/scripts/imgs.js
  mv ./imgs.data ./build-web-hybrid/imgs.data
fi
...
if [ -d ./resources/img ] && [ "$(ls -A ./resources/img/*@2x*.png 2>/dev/null)" ]; then
  ...
  mkdir -p ./build-web-hybrid/2x/
  cp ./resources/img/*@2x* ./build-web-hybrid/2x/
  cd build-web-hybrid
...
emmake make --makefile $PROJECT_NAME-hybrid-dsp.mk
...
cp $IPLUG2_ROOT/IPlug/WEB/TemplateHybrid/styles/style.css styles/style.css
