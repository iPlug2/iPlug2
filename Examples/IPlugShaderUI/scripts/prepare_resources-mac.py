...
def main():
  ...
  if os.path.exists(projectpath + "/resources/shaders/"):
    shaders = os.listdir(projectpath + "/resources/shaders/")
    for shader in shaders:
      print("copying " + shader + " to " + dst)
      shutil.copy(projectpath + "/resources/shaders/" + shader, dst)
...
#                               NSExtensionServiceRoleType = "NSExtensionServiceRoleTypeEditor",
  ...
  NSExtensionPrincipalClass = "IPlugAUViewController_vIPlugShaderUI_vIPlugShaderUI"
                             )
