...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugShaderUI Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugShaderUI Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugShaderUI Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugShaderUI installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugShaderUI Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugShaderUI installer\n"
