...
def  main():
  ...
  installer = "\installer\IPlugReaperExtension Installer.exe"
   
  if demo:
    installer = "\installer\IPlugReaperExtension Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\IPlugReaperExtension manual.pdf" 
  ]
  ...
  ZIPNAME = "IPlugReaperExtension-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "IPlugReaperExtension-v" + FULLVERSIONSTR + "-win-demo.zip"
