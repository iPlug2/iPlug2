...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugAppExperiment Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugAppExperiment Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugAppExperiment Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugAppExperiment installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugAppExperiment Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugAppExperiment installer\n"
