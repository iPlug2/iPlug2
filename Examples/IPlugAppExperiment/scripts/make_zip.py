...
def  main():
  ...
  installer = "\installer\IPlugAppExperiment Installer.exe"
   
  if demo:
    installer = "\installer\IPlugAppExperiment Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\IPlugAppExperiment manual.pdf" 
  ]
  ...
  ZIPNAME = "IPlugAppExperiment-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "IPlugAppExperiment-v" + FULLVERSIONSTR + "-win-demo.zip"
