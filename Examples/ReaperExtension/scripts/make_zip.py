...
def  main():
  ...
  installer = "\installer\ReaperExtension Installer.exe"
   
  if demo:
    installer = "\installer\ReaperExtension Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\ReaperExtension manual.pdf" 
  ]
  ...
  ZIPNAME = "ReaperExtension-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "ReaperExtension-v" + FULLVERSIONSTR + "-win-demo.zip"
