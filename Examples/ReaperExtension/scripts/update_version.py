...
def main():
  ...
  plistpath = scriptpath + "/resources/ReaperExtension-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ReaperExtension-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ReaperExtension-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ReaperExtension-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ReaperExtension-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/ReaperExtension.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/ReaperExtension.iss",inplace=1):
