...
public:
    ...
    static Bundle*      bundleWithIdentifier(const class String* pIdentifier);
...
_NS_INLINE NS::Bundle* NS::Bundle::bundleWithIdentifier(const class String* pIdentifier)
{
    return Object::sendMessage<Bundle*>(_NS_PRIVATE_CLS(NSBundle), _NS_PRIVATE_SEL(bundleWithIdentifier_), pIdentifier);
}
