...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugMetalCppUI-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugMetalCppUI-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/IPlugMetalCppUI-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/IPlugMetalCppUI-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/IPlugMetalCppUI-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/IPlugMetalCppUI.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugMetalCppUI.iss",inplace=1):
