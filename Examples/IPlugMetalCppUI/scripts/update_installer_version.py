...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugMetalCppUI Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugMetalCppUI Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugMetalCppUI Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugMetalCppUI installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugMetalCppUI Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugMetalCppUI installer\n"
