...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugChunks Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugChunks Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugChunks Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugChunks installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugChunks Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugChunks installer\n"
