...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=IPlugSpectralDisplay Demo Installer\n"
      else:
        line="OutputBaseFilename=IPlugSpectralDisplay Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the IPlugSpectralDisplay Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the IPlugSpectralDisplay installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=IPlugSpectralDisplay Demo installer\n"
     else:
       line="SetupWindowTitle=IPlugSpectralDisplay installer\n"
