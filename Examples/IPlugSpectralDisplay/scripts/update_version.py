...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugSpectralDisplay-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugSpectralDisplay-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/IPlugSpectralDisplay-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/IPlugSpectralDisplay-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/IPlugSpectralDisplay-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/IPlugSpectralDisplay.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugSpectralDisplay.iss",inplace=1):
