...
def  main():
  ...
  installer = "\installer\IPlugSpectralDisplay Installer.exe"
   
  if demo:
    installer = "\installer\IPlugSpectralDisplay Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\IPlugSpectralDisplay manual.pdf" 
  ]
  ...
  ZIPNAME = "IPlugSpectralDisplay-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "IPlugSpectralDisplay-v" + FULLVERSIONSTR + "-win-demo.zip"
