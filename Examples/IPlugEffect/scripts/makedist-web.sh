...
python $EMSCRIPTEN/tools/file_packager.py ./build-web/resources.data --use-preload-plugins --preload ./resources/img@/ --preload-file ./resources/fonts@/ --js-output=./build-web/resources.js
echo -
