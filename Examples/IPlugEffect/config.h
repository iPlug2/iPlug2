...
#define APP_HAS_TRANSPORT_BAR 1
#define APP_TRANSPORT_BAR_HEIGHT 42
#define APP_TRANSPORT_BAR_STYLE DEFAULT_STYLE
#define APP_TRANSPORT_BAR_NEW_BUTTON 1
#define APP_TRANSPORT_BAR_SAVE_BUTTON 1
#define APP_TRANSPORT_BAR_OPEN_BUTTON 1
