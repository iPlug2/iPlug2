...
if (WIN32)
  if (CMAKE_SYSTEM_PROCESSOR MATCHES "X86")
    set(vst3_names "VST3")
    set(vst3_paths "C:/Program Files (x86)/Common Files" "C:/Program Files/Common Files")
    set(vst3_target_arch "x86")
  elseif ((CMAKE_HOST_SYSTEM_PROCESSOR MATCHES "AMD64") OR (CMAKE_HOST_SYSTEM_PROCESSOR MATCHES "IA64"))
    set(vst3_names "VST3")
    set(vst3_paths "C:/Program Files/Common Files")
...
elseif (CMAKE_SYSTEM_NAME MATCHES "Darwin")
  set(vst3_names "VST3")
  set(vst3_paths "$ENV{HOME}/Library/Audio/Plug-Ins")

elseif (CMAKE_SYSTEM_NAME MATCHES "Linux")
  set(vst3_names ".vst3")
  set(vst3_paths "$ENV{HOME}")
...
target_include_directories(${tgt} INTERFACE "${VST3_SDK_DIR}")
