...
public:
  ...
  /** Called to layout controls when the GUI is initially opened and again if the UI size changes. On subsequent calls
   * you can check for the existence of controls and behave accordingly. Default impl calls  mLayoutFunc */
