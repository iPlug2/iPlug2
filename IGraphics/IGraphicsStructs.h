...
using IMsgBoxCompletionHandlerFunc = std::function<void(EMsgBoxResult result, const char* str)>;
using IFileDialogCompletionHandlerFunc = std::function<void(const WDL_String& fileName, const WDL_String& path, const void* pBookmarkData, int bookmarkSize)>;
