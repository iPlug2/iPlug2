...
#ifndef DEFAULT_PATH
	#define DEFAULT_PATH "~/Desktop"
#endif

#ifndef DEFAULT_FONT
	#define DEFAULT_FONT "Roboto-Regular"
#endif
...
namespace iplug::igraphics
{
	...
	// If IGraphics::ShowMessageBox can't return inline, it returns kNoResult
	// (e.g. because it requires an asynchronous call)
	enum EMsgBoxResult
	{
		kNoResult,
		kOK     = 1,
	...
	inline constexpr int DEFAULT_ANIMATION_DURATION = 100;

	inline constexpr int MAX_IMG_SCALE          = 3;
	inline constexpr int DEFAULT_TEXT_ENTRY_LEN = 7;
	inline constexpr double DEFAULT_GEARING     = 4.0;

	inline constexpr float GRAYED_ALPHA = 0.25f;

	inline constexpr float DEFAULT_TEXT_SIZE = 14.f;
	inline constexpr int FONT_LEN            = 64;
	...
	static const char* kGestureTypeStrs[12] = {"Unknown",
											   "DoubleTap",
											   "TripleTap",
											   "LongPress1",
											   "LongPress2",
