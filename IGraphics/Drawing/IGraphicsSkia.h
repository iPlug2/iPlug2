...
class IGraphicsSkia : public IGraphicsPathBase
{
 ...
 public:
	...
	{
		mMainPath.moveTo(mMatrix.mapXY(x, y));
	}
	void PathLineTo(float x, float y) override
	{
		mMainPath.lineTo(mMatrix.mapXY(x, y));
	}
	...
	void PathStroke(const IPattern& pattern,
					float thickness,
	...
	// void DrawLine(const IColor& color, float x1, float y1, float x2, float y2, const IBlend* pBlend, float thickness)
	// override; void DrawGrid(const IColor& color, const IRECT& bounds, float gridSizeH, float gridSizeV, const IBlend*
	// pBlend, float thickness) override; void DrawData(const IColor& color, const IRECT& bounds, float* normYPoints, int
	// nPoints, float* normXPoints, const IBlend* pBlend, float thickness) override; void DrawDottedLine(const IColor&
	// color, float x1, float y1, float x2, float y2, const IBlend* pBlend, float thickness, float dashLen) override;
	// void DrawTriangle(const IColor& color, float x1, float y1, float x2, float y2, float x3, float y3, const IBlend*
	// pBlend, float thickness) override;
	void DrawRect(const IColor& color, const IRECT& bounds, const IBlend* pBlend, float thickness) override;
	void DrawRoundRect(
		const IColor& color, const IRECT& bounds, float cornerRadius, const IBlend* pBlend, float thickness) override;
	// void DrawRoundRect(const IColor& color, const IRECT& bounds, float cRTL, float cRTR, float cRBR, float cRBL,
	// const IBlend* pBlend, float thickness) override; void DrawConvexPolygon(const IColor& color, float* x, float* y,
	// int nPoints, const IBlend* pBlend, float thickness) override;
	void DrawArc(const IColor& color,
				 float cx,
				 float cy,
				 float r,
				 float a1,
	...
	// void DrawDottedRect(const IColor& color, const IRECT& bounds, const IBlend* pBlend, float thickness, float
	// dashLen) override;
	void DrawEllipse(const IColor& color, const IRECT& bounds, const IBlend* pBlend, float thickness) override;
	// void DrawEllipse(const IColor& color, float x, float y, float r1, float r2, float angle, const IBlend* pBlend,
	// float thickness) override;

	// void FillTriangle(const IColor& color, float x1, float y1, float x2, float y2, float x3, float y3, const IBlend*
	// pBlend) override;
	...
	// void FillRoundRect(const IColor& color, const IRECT& bounds, float cRTL, float cRTR, float cRBR, float cRBL,
	// const IBlend* pBlend) override; void FillConvexPolygon(const IColor& color, float* x, float* y, int nPoints, const
	// IBlend* pBlend) override;
	...
	// void FillEllipse(const IColor& color, float x, float y, float r1, float r2, float angle, const IBlend* pBlend)
	// override;
#endif
 ...
 protected:
	...
	APIBitmap* LoadAPIBitmap(const char* fileNameOrResID,
							 int scale,
