...
{
  return [UIColor colorWithRed:(double)c.R / 255.0
...
@interface IGRAPHICS_VIEW
: UIView <UITextFieldDelegate, UIPopoverPresentationControllerDelegate, UIGestureRecognizerDelegate, UITraitEnvironment,
