 ...
 * 1. **Runtime compilation**: Pass MSL source to the constructor or SetShaderStr()
 * 2. **Pre-compiled**: Add .metal files to your Xcode project and use SetShaderFunctions()
 *
