...
public:
  ...
  void OnInit() override
  {
    int idx = 1; // 0 = unknown
    for (auto& type :
         {EGestureType::DoubleTap, EGestureType::TripleTap, EGestureType::LongPress1, EGestureType::LongPress2,
          EGestureType::SwipeLeft, EGestureType::SwipeRight, EGestureType::SwipeUp, EGestureType::SwipeDown,
          EGestureType::Pinch, EGestureType::Rotate, EGestureType::Pan})
    {
