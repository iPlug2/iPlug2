# common-web-hybrid.mk
# Build configuration for iPlug2 hybrid split DSP/UI builds
#
...
HYBRID_DSP_SRC = $(IPLUG_WEB_PATH)/IPlugHybridDSP.cpp \
	$(IPLUG_PATH)/IPlugProcessor.cpp

# UI module source files (runs on main thread with IGraphics)
HYBRID_UI_SRC = $(IPLUG_WEB_PATH)/IPlugHybridUI.cpp \
	$(IGRAPHICS_SRC) \
...
HYBRID_DSP_CFLAGS = -DHYBRID_DSP_API \
-DIPLUG_DSP=1 \
-DNO_IGRAPHICS \
-DSAMPLE_TYPE_FLOAT

# UI module CFLAGS - IGraphics and editor
HYBRID_UI_CFLAGS = -DHYBRID_UI_API \
-DIPLUG_EDITOR=1

# DSP module exports (minimal - JS calls via emscripten bindings)
HYBRID_DSP_EXPORTS = "['_malloc', '_free']"

# UI module exports
HYBRID_UI_EXPORTS = "['_malloc', '_free', '_main', '_iplug_fsready', '_iplug_syncfs']"
...
HYBRID_DSP_LDFLAGS = -s EXPORTED_FUNCTIONS=$(HYBRID_DSP_EXPORTS) \
...
HYBRID_UI_LDFLAGS = -s EXPORTED_FUNCTIONS=$(HYBRID_UI_EXPORTS) \
