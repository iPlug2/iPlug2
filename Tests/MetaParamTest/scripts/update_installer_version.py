...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=MetaParamTest Demo Installer\n"
      else:
        line="OutputBaseFilename=MetaParamTest Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the MetaParamTest Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the MetaParamTest installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=MetaParamTest Demo installer\n"
     else:
       line="SetupWindowTitle=MetaParamTest installer\n"
