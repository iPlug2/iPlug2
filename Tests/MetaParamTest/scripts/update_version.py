...
def main():
  ...
  plistpath = scriptpath + "/resources/MetaParamTest-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MetaParamTest-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MetaParamTest-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MetaParamTest-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MetaParamTest-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/MetaParamTest.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/MetaParamTest.iss",inplace=1):
