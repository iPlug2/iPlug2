/*
  This is the initial ios app extension view controller, which is referenced by MetaParamTest-iOS-MainInterface storyboard
*/

import UIKit
import CoreAudioKit

public class MetaParamTestViewController: AUViewController {
  ...
  func connectViewWithAU() {
    // To use the generic UI (swift), change the view in MetaParamTest-iOS-MainInterface.storyboard to custom class: GenericUI  module: MetaParamTestFramework
