...
def  main():
  ...
  installer = "\installer\IGraphicsStressTest Installer.exe"
   
  if demo:
    installer = "\installer\IGraphicsStressTest Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\IGraphicsStressTest manual.pdf" 
  ]
  ...
  ZIPNAME = "IGraphicsStressTest-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "IGraphicsStressTest-v" + FULLVERSIONSTR + "-win-demo.zip"
