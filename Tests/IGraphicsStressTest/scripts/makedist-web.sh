...
echo "AudioWorkletGlobalScope.WAM = AudioWorkletGlobalScope.WAM || {}; AudioWorkletGlobalScope.WAM.IGraphicsStressTest = { ENVIRONMENT: 'WEB' };" > IGraphicsStressTest-wam.tmp.js;
cat IGraphicsStressTest-wam.js >> IGraphicsStressTest-wam.tmp.js
mv IGraphicsStressTest-wam.tmp.js IGraphicsStressTest-wam.js

cp ../../../../Dependencies/IPlug/WAM_SDK/wamsdk/*.js .
cp ../../../../Dependencies/IPlug/WAM_AWP/*.js .
cp ../../../../IPlug/WEB/Template/scripts/IPlugWAM-awn.js IGraphicsStressTest-awn.js
...
sed -i.bak s/NAME_PLACEHOLDER/IGraphicsStressTest/g index.html
rm *.bak
...
emmake make --makefile projects/IGraphicsStressTest-wam-controller.mk EXTRA_CFLAGS=-DWEBSOCKET_CLIENT=$websocket
