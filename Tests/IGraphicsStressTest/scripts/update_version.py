...
def main():
  ...
  plistpath = scriptpath + "/resources/IGraphicsStressTest-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IGraphicsStressTest-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/IGraphicsStressTest-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/IGraphicsStressTest-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/IGraphicsStressTest-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/IGraphicsStressTest.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/IGraphicsStressTest.iss",inplace=1):
