  ...
  mLayoutFunc = [&](IGraphics* pGraphics) {
    ...
    auto chooseTestControl = [&, pGraphics, testRect](int idx) {
      ...
      switch (idx)
      {
        ...
        case 12:
          pNewControl =
            new TestBlendControl(testRect, pGraphics->LoadBitmap(SRC_FN), pGraphics->LoadBitmap(DST_FN), kParamDummy);
          break;
        ...
        case 23:
          pNewControl = new TestMTControl(testRect);
          pNewControl->SetWantsMultiTouch(true);
          break;
    ...
    pGraphics->AttachControl(new IVRadioButtonControl(
      bounds.FracRectHorizontal(0.2f),
    ...
    pGraphics->AttachControl(
      new IVSliderControl(bounds.FracRectHorizontal(0.2f, true).GetCentredInside(100, 200), kParamDummy, "Value"));
